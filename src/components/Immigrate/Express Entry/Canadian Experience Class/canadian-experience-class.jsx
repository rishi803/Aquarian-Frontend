...
const tableContentData = [
  {
    id: 1,
    content: "What is the Canadian Experience Class (CEC)?",
    scrollTo: "#about-cec",
  },
  {
    id: 2,
    content: "Eligibility Criteria for the Canadian Experience Class (CEC)",
    scrollTo: "#eligibility-cec",
  },
  {
    id: 3,
    content: "How to Apply for the Canadian Experience Class (CEC)",
    scrollTo: "#apply-cec",
  },
  {
    id: 4,
